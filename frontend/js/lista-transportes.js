...
document.addEventListener('DOMContentLoaded', async () => {
 ...
 function obtenerTextoEstado(estado) {
  ...
  function actualizarPaginacion() {
    ...
    // Actualizar cantidad de transportes
    document.getElementById('totalTransportes').textContent = `Cantidad de transportes: ${totalRegistros}`;
  }
  ...
  function setVolverOrigin() {
    ...
    } else if (!referrer.includes('lista-transportes')) {
      sessionStorage.setItem('originFrom', 'panel-principal');
    }
  }

  // Actualizar el botón de volver según el origen
  function updateBtnVolverTransporte() {
    const btnVolver = document.getElementById('btnVolverTransporte');
